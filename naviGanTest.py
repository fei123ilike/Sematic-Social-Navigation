...
import tf
import sys
sys.path.append('/home/asus/SocialNavigation/src/navigan/scripts/sgan')
import torch
...
class naviGan(object):
    ...
    def trackedPtCallback(self, _scanIn):
        ...
        if (self.predictGoal and minDistance <= VALIDSCAN):
    ...
    def predict(self, current_time):
        ...
        self.next_waypoint = Point(ptf[1,0],ptf[1,1], 0)
        # reach the goal check  need to be tuned
        if self.reachGoalCheck(self.next_waypoint, self.goalData, 0.2) is not True:
...
if __name__ == '__main__':
    ...
    CHECKPOINT = '/home/asus/SocialNavigation/src/navigan/models/benchmark_zara1_with_model.pt'
